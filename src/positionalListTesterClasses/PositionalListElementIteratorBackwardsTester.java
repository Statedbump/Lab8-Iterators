...
import llPositionalList.PositionalListElementIteratorBackwards;

import llPositionalList.LinkedPositionalList;

public class PositionalListElementIteratorBackwardsTester {
	...
	private static void showList2(String msg, LinkedPositionalList<Integer> list) {
		System.out.print(msg); 
		Iterator<Integer> iter = new PositionalListElementIteratorBackwards<>(list); 
		while (iter.hasNext())
